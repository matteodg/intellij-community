...
/**
 * Parses assertion comparison messages from Surefire XML reports.
 * Patterns are aligned with [org.jetbrains.plugins.gradle.execution.test.runner.events.AssertionMessageParser].
 */
internal object MavenAssertionMessageParser {
